...
window.FAMILY = {
  ...
  people: [
    ...
    { id: "tbd-narasamma", name: "Narasamma Makani", family: "tbd",
      marriedInto: "makani", gen: 0, sex: "u", alive: false },
    { id: "tbd-chitamma", name: "Chitamma Peddi", family: "tbd",
      marriedInto: "peddi", gen: 0, sex: "f", todo: "birth family (intiperu)" },
    { id: "tbd-jayamma", name: "Jayamma Dasari", family: "tbd", gen: 0,
    ...
    { id: "peddi-naga", name: "Naga Mohan Rao Peddi", family: "peddi", gen: 1,
      sex: "u", order: 1 },
    ...
    { id: "maddala-jayalakshmi", name: "Jayalakshmi Maddala",
      family: "devisetti", marriedInto: "maddala", gen: 2, sex: "f", order: 1 },
    { id: "nimmala-kumar", name: "Venkata Satya Kumar Nimmala",
      family: "nimmala", gen: 2, sex: "u", order: 1 },
    { id: "tbd-sakkubai", name: "Sakkubai", family: "tbd", gen: 2, sex: "u",
      order: 1 },
    { id: "tbd-bhanupriya", name: "Bhanupriya", family: "tbd", gen: 2,
      sex: "u", order: 1 },
    { id: "tbd-malathi-2", name: "Malathi", family: "sunkara", gen: 2,
      sex: "u", order: 1 },
    ...
    { id: "Chanthati-seetharathnamma", name: "Seetharathnamma Chanthati",
      family: "devisetti", marriedInto: "Chanthati", gen: 2, sex: "f",
      order: 2 },
    { id: "tbd-chinnamma", name: "Chinnamma", family: "tbd", gen: 2, sex: "u",
      order: 2 },
    { id: "tbd-malathi", name: "Malathi", family: "tbd", gen: 2, sex: "u",
      order: 2 },
    { id: "tbd-bhanupriya-2", name: "Bhanupriya", family: "sunkara", gen: 2,
      sex: "u", order: 2 },
    ...
    { id: "kumari-naga", name: "Naga Ganga Surya Kumari Koratani",
      family: "nimmala", marriedInto: "koratani", gen: 2, sex: "f", order: 3 },
    ...
    { id: "makani-sarojini", name: "Sarojini Gaurisetti", family: "makani",
      marriedInto: "gowrisetti", gen: 2, sex: "f", order: 5 },
    ...
    { id: "rao-nagabhushan", name: "Nagabhushan Rao Gaurisetti",
      family: "gaurisetti", gen: 2, sex: "m" },
    { id: "tbd-sujatha-3", name: "Sujatha Nimmala", family: "sunkara",
      marriedInto: "nimmala", gen: 2, sex: "f" },
    ...
    { id: "lakshmi-bhuavana", name: "Bhuavana Lakshmi Nimmala",
      family: "nimmala", gen: 3, sex: "u", order: 1 },
    ...
    { id: "makani-meena", name: "Meena Veerisetti", family: "makani",
      marriedInto: "veerisetti", gen: 3, sex: "f", order: 2 },
    { id: "makani-praveen", name: "Praveen Gaurisetti", family: "gaurisetti",
      gen: 3, sex: "m", order: 2 },
    { id: "nimmala-nikhil", name: "Nikhil Nimmala", family: "nimmala", gen: 3,
      sex: "u", order: 2 },
    ...
    { id: "makani-bujji", name: "Suguna (Suneetha) Veerisetti",
      family: "makani", marriedInto: "veerisetti", gen: 3, sex: "f", order: 3 },
    ...
    { id: "makani-baby-2", name: "Hemakumari Kosanam (Baby)",
      family: "makani", marriedInto: "kosanam", gen: 3, sex: "f", order: 4 },
